...
public class Info_Tracker : MonoBehaviour {

    [SerializeField]private Text nameField, balanceField, healthField,gradeField,jobField,lectureField,bufferField;
    ...
    public void initial()
    {
        ...
        bufferField = transform.Find("SkillCard").Find("Text").GetComponent<Text>();
    ...
    public void updatebuffercard(string bufferCard)
    {
        Debug.Log(bufferCard);
        this.bufferField.text = "buff牌:  " + bufferCard;
    }
}
